...
import Logo from '../images/icons8-e-100.png'
      ...
      <>
        <Navbar className="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav" expand="lg"
          ...
          <div className="container">
            <a className="navbar-brand js-scroll-trigger" href="#page-top" onClick={Scroller.handleAnchorScroll}><img src={Logo} /></a>
          ...
          <div className="container h-100">
            <div className="row h-100 align-items-center justify-content-center text-center">
              <div className="col-lg-10 align-self-end">
                <h1 className="text-capital text-white font-weight-bold">Hello everyBody Im Erfan front-end developer Welcome to my Portfolio</h1>
                <hr className="divider my-4"/>
              </div>
              <div className="col-lg-8 align-self-baseline">
                <p className="text-white-75 font-weight-light mb-5">Please visit my site and scrol down to see my project and About me 
                </p>

...
import mypic from '../images/20200619_194233.jpg'
      ...
      <Layout>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                {/* <h2 className="text-white mt-0 d-flex justify-content-between">Hello Again</h2> */}
                <img className="rounded-circle" src={mypic} width="300px" height="300px" />
                
                <hr className="divider light my-4"/>
                <p className="text-white-50 mb-4">Im erfan software enginer and i love programing will i learning web programing and i can 
                use React framWork and Next.js and TypeScript i study in university little C# and C++ going to learning This programing</p>
        ...
        <section className="page-section bg-dark text-white">
          <div className="container text-center">
            <h2 className="mb-4">See my Project and enjoy!</h2>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                ...
                <div>+98 9191398649</div>
              </div>
              <div className="col-lg-4 mr-auto text-center">
                <i className="fas fa-envelope fa-3x mb-3 text-muted"></i>
                <a className="d-block" href="mailto:contact@yourwebsite.com">erfano2013@gmail.com.com</a>
              </div>
            </div>
          </div>
        </section>
